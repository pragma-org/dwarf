...
| `handshake_cases_match_expected` | Assert every retained handshake case (e.g. the version-table forward-compatibility set) ended in its declared outcome on the Amaru or Cardano-node target. | dev | full · cn+amaru | — |
