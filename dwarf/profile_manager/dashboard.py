...
from profile_manager.views.learn_measurement_coverage import render_learn_measurement_coverage
...
def render_route_html(route, *, token=None):
    ...
    routes = {
        ...
        "/learn/measurement-coverage": render_learn_measurement_coverage,
