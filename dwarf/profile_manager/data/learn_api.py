...
def html_route_groups() -> list[dict[str, Any]]:
    ...
    operate = [
        ...
        "/operate/measurements", "/operate/measurements/new",
        "/operate/measurements/<id>", "/operate/measurements/<id>/edit",
        "/operate/measurement-profiles", "/operate/measurement-profiles/new",
        "/operate/measurement-profiles/<id>", "/operate/measurement-profiles/<id>/edit",
